...
static unsigned int ng4[] = {0U, 0U, 0U, 0U, 0U, 0U, 0U, 0U, 0U, 0U, 0U, 0U};
...
LAB2:    t2 = (t0 + 25184U);
    t4 = *((char **)t2);
    t2 = ((char*)((ng4)));
    xsi_vlogtype_concat(t3, 201, 201, 2U, t2, 185, t4, 16);
    t5 = (t0 + 74392);
    t6 = (t5 + 56U);
    t7 = *((char **)t6);
    t8 = (t7 + 56U);
    t9 = *((char **)t8);
    xsi_vlog_bit_copy(t9, 0, t3, 0, 201);
    xsi_driver_vfirst_trans(t5, 0, 200);
    t10 = (t0 + 71544);
    *((int *)t10) = 1;
